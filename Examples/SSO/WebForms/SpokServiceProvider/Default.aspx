<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SpokServiceProvider._Default" %>
...
<body>
    ...
    <div>
		<h1>Welcome to <B>SPOK</B> Service Provider Site</h1>
		<p>
			You are logged in as <%= Context.User.Identity.Name %>.
		</p>
        <p>
            <img src="App_Data/spoklogo.jpg"/>
        </p>
