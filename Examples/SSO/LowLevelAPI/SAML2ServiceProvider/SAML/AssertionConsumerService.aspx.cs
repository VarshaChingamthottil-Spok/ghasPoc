        ...
        private void ReceiveSAMLResponse(ref SAMLResponse samlResponse, ref string relayState)
        {
            ...
            switch (bindingType)
            {
                case SAMLIdentifiers.BindingURIs.HTTPPost:
                    ServiceProvider.ReceiveSAMLResponseByHTTPPost(new HttpRequestWrapper(Request), out samlResponseXml, out relayState);
                    break;
                ...
                case SAMLIdentifiers.BindingURIs.HTTPArtifact:
                    ...
                    ServiceProvider.ReceiveArtifactByHTTPArtifact(new HttpRequestWrapper(Request), false, out httpArtifact, out relayState);
