...
namespace SAML2ServiceProvider.SAML
{
    public partial class SLOService : System.Web.UI.Page
    {
        ...
        private void SendLogoutResponse(ref LogoutResponse logoutResponse)
        {
            ...
            SingleLogoutService.SendLogoutResponseByHTTPRedirect(new HttpResponseWrapper(Response), WebConfigurationManager.AppSettings["idpLogoutURL"], logoutResponseXml, null, x509Certificate.PrivateKey, null);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                SingleLogoutService.ReceiveLogoutMessageByHTTPRedirect(new HttpRequestWrapper(Request), out logoutMessage, out relayState, out isRequest, out signed, x509Certificate.PublicKey.Key);
