        ...
        private void RequestLoginAtIdentityProvider()
        {
            ...
            switch (spToIdPBindingRadioButtonList.SelectedValue)
            {
                case SAMLIdentifiers.BindingURIs.HTTPRedirect:
                    ...
                    ServiceProvider.SendAuthnRequestByHTTPRedirect(new HttpResponseWrapper(Response), idpURL, authnRequestXml, relayState, x509Certificate.PrivateKey);

                    break;
                case SAMLIdentifiers.BindingURIs.HTTPPost:
                    ServiceProvider.SendAuthnRequestByHTTPPost(new HttpResponseWrapper(Response), idpURL, authnRequestXml, relayState);
                ...
                case SAMLIdentifiers.BindingURIs.HTTPArtifact:
                    ...
                    // Send the artifact.
                    ServiceProvider.SendArtifactByHTTPArtifact(new HttpResponseWrapper(Response), idpURL, httpArtifact, relayState, false);
                    break;
            }
        }
