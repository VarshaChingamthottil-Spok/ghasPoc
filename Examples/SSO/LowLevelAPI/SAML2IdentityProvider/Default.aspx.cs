    ...
    public partial class _Default : System.Web.UI.Page
    {
        ...
        protected void logoutButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string logoutURL = WebConfigurationManager.AppSettings["spLogoutURL"];
                X509Certificate2 x509Certificate = (X509Certificate2)Application[Global.IdPX509Certificate];

                SingleLogoutService.SendLogoutRequestByHTTPRedirect(new HttpResponseWrapper(Response), logoutURL, logoutRequestXml, null, x509Certificate.PrivateKey, null);
            ...
            {
                Trace.Write("IdP", "Error on logout page", exception);
            }
        }
    }
}
