        ...
        private void ReceiveAuthnRequest(out AuthnRequest authnRequest, out string relayState)
        {
            ...
            switch (bindingType)
            {
                case SAMLIdentifiers.BindingURIs.HTTPRedirect:
                    ...
                    IdentityProvider.ReceiveAuthnRequestByHTTPRedirect(new HttpRequestWrapper(Request), out authnRequestXml, out relayState, out signed, x509Certificate.PublicKey.Key);
                    break;

                case SAMLIdentifiers.BindingURIs.HTTPPost:
                    IdentityProvider.ReceiveAuthnRequestByHTTPPost(new HttpRequestWrapper(Request), out authnRequestXml, out relayState);
                    break;
                ...
                case SAMLIdentifiers.BindingURIs.HTTPArtifact:
                    ...
                    IdentityProvider.ReceiveArtifactByHTTPArtifact(new HttpRequestWrapper(Request), false, out httpArtifact, out relayState);
        ...
        private void SendSAMLResponse(SAMLResponse samlResponse, SSOState ssoState)
        {
            ...
            switch (ssoState.idpProtocolBinding)
            {
                case SAMLIdentifiers.Binding.HTTPPost:
                    IdentityProvider.SendSAMLResponseByHTTPPost(new HttpResponseWrapper(Response), ssoState.assertionConsumerServiceURL, samlResponseXml, ssoState.relayState);
                    break;
                ...
                case SAMLIdentifiers.Binding.HTTPArtifact:
                    ...
                    // Send the artifact.
                    IdentityProvider.SendArtifactByHTTPArtifact(new HttpResponseWrapper(Response), ssoState.assertionConsumerServiceURL, httpArtifact, ssoState.relayState, false);
                    break;
