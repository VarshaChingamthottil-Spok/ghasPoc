...
namespace SAML2IdentityProvider.SAML
{
    public partial class SLOService : System.Web.UI.Page
    {
        ...
        private void SendLogoutResponse(LogoutResponse logoutResponse, string relayState)
        {
            ...
            SingleLogoutService.SendLogoutResponseByHTTPRedirect(new HttpResponseWrapper(Response), WebConfigurationManager.AppSettings["spLogoutURL"], logoutResponseXml, null, x509Certificate.PrivateKey, null);
